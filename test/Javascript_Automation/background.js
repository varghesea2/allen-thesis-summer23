"use strict"
var entries = [];
var test = "testing the value1";
//= window.gEntries;
function API_COUNT() {
const linkElement = document.createElement('link');
var CountOfApis = {};
test = "testing the value2"
//entries = [];
...
//     download_csv_file(globalEntries);
// });
// exportJsonButton.addEventListener('click', () => {
//     exportToJsonFile(globalEntries);
// });
...
//     let csv = 'API,Count,URL\n';

//     // Add a row for each entry in the groupedData object
//     for (const api in groupedData) {
//         for (const url in groupedData[api]) {
//             csv += `${api},${groupedData[api][url]},${url}\n`;
//         }
//     }
...
module.exports.getArray = (entries) =>{
    return entries;
}